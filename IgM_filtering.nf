...
workflow {
    ...
    merged_forward_reverse_primer_reads_duplicates_removed = remove_duplicate_merged_forward_reverse_reads(merged_forward_reverse_primer_reads, false, "${input_file_basename}-reads_with_an_IgM_motif_or_reverse_complimented_reverse_primer.fastq.gz")
