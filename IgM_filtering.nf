...
workflow {
    ...
    relabeled_sequences = simplify_read_labels(params.input_file, '(.*?)\s.*', '$1', 'dont_save')
       
    reads_with_forward_primer = get_forward_primer_reads(relabeled_sequences, params.forward_primer, params.forward_primer_num_mismatches, false, 'dont_save')
    reads_with_reverse_primer = get_reverse_primer_reads(relabeled_sequences, params.reverse_primer, params.reverse_primer_num_mismatches, false, 'dont_save')
     
    labeled_reads_with_forward_primer = label_forward_primer_reads(reads_with_forward_primer, '(.*)', '$1\thas_forward_primer', 'reads_with_forward_primer.fastq')
    labeled_reads_with_reverse_primer = label_reverse_primer_reads(reads_with_reverse_primer, '(.*)', '$1\thas_reverse_primer', 'reads_with_reverse_primer.fastq')
    
    reverse_complimented_reverse_primer_reads              = reverse_compliment_reverse_primer_reads(reads_with_reverse_primer)
    labeled_reverse_complimented_reads_with_reverse_primer = label_reverse_complimented_reverse_primer_reads(reverse_complimented_reverse_primer_reads, '(.*)', '$1\thas_reverse_primer:reverse_complimented', 'dont_save')
    
    reads_with_IgM_motif1 = get_IgM_motif1_reads(labeled_reads_with_forward_primer, params.IgM_motif1, params.IgM_motif1_num_mismatches, false, 'dont_save')
    reads_with_IgM_motif2 = get_IgM_motif2_reads(labeled_reads_with_forward_primer, params.IgM_motif2, params.IgM_motif2_num_mismatches, false, 'dont_save')
    
    labeled_reads_with_IgM_motif1 = label_IgM_motif1_reads(reads_with_IgM_motif1, '(.*)', '$1\thas_IgM_motif1', 'dont_save')
    labeled_reads_with_IgM_motif2 = label_IgM_motif2_reads(reads_with_IgM_motif2, '(.*)', '$1\thas_IgM_motif2', 'dont_save')
    
    
    reads_with_both_IgM_motifs         = get_reads_with_both_IgM_motifs(reads_with_IgM_motif1, reads_with_IgM_motif2, false)
    labeled_reads_with_both_IgM_motifs = label_both_IgM_motifs_reads(reads_with_both_IgM_motifs, '(.*?)\t.*', '$1\thas_forward_primer\thas_both_IgM_motifs', 'reads_with_an_IgM_motif.fastq')
    ...
    cleaned_all_IgM_motif_reads = remove_duplicate_IgM_motif_reads( all_IgM_motif_reads, false, 'dont_save' )
    ...
    pre_CDR3_sequences                           = extract_pre_CDR3_sequences(merged_forward_reverse_primer_reads, pre_CDR3_locations, 'dont_save')
    pre_CDR3_sequnces_duplicates_removed         = remove_duplicate_pre_CDR3_sequences( pre_CDR3_sequences, false, 'dont_save' )
    labeled_pre_CDR3_sequnces_duplicates_removed = label_pre_CDR3_sequences(pre_CDR3_sequnces_duplicates_removed, '(.*?):.*', '$1\thas_pre_CDR3_motif', 'reads_with_pre_CDR3_motif.fastq')


    post_CDR3_locations                           = get_post_CDR3_locations(pre_CDR3_sequnces_duplicates_removed, params.post_CDR3_motifs, true)
    post_CDR3_sequences                           = extract_post_CDR3_sequences(pre_CDR3_sequnces_duplicates_removed, post_CDR3_locations, 'dont_save')
    labeled_post_CDR3_sequnces_duplicates_removed = label_post_CDR3_sequences(post_CDR3_sequences, '(.*?):.*', '$1\thas_pre_CDR3_motif\thas_post_CDR3_motif', 'reads_with_pre_and_post_CDR3_motifs.fastq')
    
    pre_and_post_CDR3_match_lengths( post_CDR3_locations, params.length_file_offset, 'results.tsv' )
}
